...
from . import gettestargs
from . import hashkey
from math import floor
from matplotlib import pyplot as plt
from scipy import interpolate

args = gettestargs.gettestargs()
...
for image in imagelist:
    ...
    cv2.imwrite('./upload/' + os.path.splitext(os.path.basename(image))[0] + '_result.bmp', cv2.cvtColor(result, cv2.COLOR_RGB2BGR))
    imagecount += 1
