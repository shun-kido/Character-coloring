...
import pickle
import sys
from raisr.gaussian2d import gaussian2d
from raisr.gettestargs import gettestargs
...
def re_colored(image):
    ...
    cv2.imwrite('upload/' + os.path.splitext(os.path.basename(image))[0] + '_result.jpg', cv2.cvtColor(result, cv2.COLOR_RGB2BGR))
...
if __name__=='__main__':
    imagelist = ['./raisr/test/color_a.jpg']
    #imagelist = get_img('./raisr/test')
    #print(imagelist)
    ...
    #    return '../upload' + os.path.splitext(os.path.basename(image))[0] + '_result.jpg'
